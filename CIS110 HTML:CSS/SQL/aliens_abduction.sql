...
SELECT*FROM aliens_abduction WHERE first_name LIKE '%d%'; 
SELECT*FROM aliens_abduction WHERE first_name LIKE 's%'; 
select count(*) from aliens_abduction;

INSERT INTO aliens_abduction VALUES ('mike', 'James', '2015-08-10', '3 minutes', 'one hundred', 'big and heavy', 'ate pizza', 'no', 'none', 'ybl@uoregon.net');
