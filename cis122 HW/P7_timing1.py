...
print("the factors that influence search speed on a linear search is, file size, and\nwhether you search for an element towards the origin(faster), or far from the origin(slower).")
print(" ")
print("in a binary search, every search from a file takes the same amount of time to return the results")
